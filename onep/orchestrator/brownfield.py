...
- expected_files: 预计需要修改的项目相对路径数组，至少包含主文件
- dependencies: 必须先完成的优化方向标题数组，没有则为空数组
...
对每个文件分片输出一行 JSON，并原样返回输入给出的 chunk_id：
{{"file": "<path>", "chunk_id": "<chunk_id>", "is_strategy": true/false, "reason": "<一句话理由>"}}
